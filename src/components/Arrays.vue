<template>
  <div class="arrays">
    <div class="arrays-list">
      ...
      <div class="msg warning" v-if="pvarrays.length == 0">System requires at least one inverter.</div>
      <ul>
        <array-view class="array" v-for="(pvarray, index) in pvarrays" :key="index" :index="index" :pvarray="pvarray"/>
      </ul>
    </div>
  </div>
</template>
